...
"""path = '/home/jboivin/Documents/PyTorch-2D-3D-UNet-Tutorial-master/CHASEDB1'
inputs = [path + '/Input/' + f for f in os.listdir(path + '/Input/')]
targets = [path + '/Target/' + f for f in os.listdir(path + '/Target/')]
